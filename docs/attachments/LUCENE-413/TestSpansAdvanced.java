...
public class TestSpansAdvanced extends TestCase {
    ...
    System.out.println(i + " field: " + hits.doc(i).get(FIELD_ID));
            assertEquals(expectedIds[i], hits.doc(i).get(FIELD_ID));
            if (expectedScores[i] != hits.score(i)) {
              System.out.println(i + " warning, expected score: " + expectedScores[i] + ", actual " + hits.score(i));
            }
            else {
