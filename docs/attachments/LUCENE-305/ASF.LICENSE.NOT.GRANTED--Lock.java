...
public abstract class Lock {
  ...
  /**
   * new field to hold name of this lock - only used
   * for custom locks...added by Jeff Patterson NOV-08-2004
   * getter and setter methods added for this member as well
   */
  ...
  /**
   * setter for the unique lock name
   * @param value   unique value to assign lock name
   */
  protected void setLockName(String value) {
    lockName = value;
  }
