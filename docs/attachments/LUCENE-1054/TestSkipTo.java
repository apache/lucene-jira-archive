...
public class TestSkipTo extends LuceneTestCase {
        ...
        public void testSkipTo() throws Exception {
                ...
                for (int i = 0; i < dirs.length; i++) {
                        dirs[i] = FSDirectory.getDirectory(tempDir
                ...
                for (int i = 0; i < 100; i++) {
                        for (int j = 0; j < 1000; j++) {
                                try {
                                        doTest(reader, docs, Integer.toString(i), Integer.toString(j));
                                } catch (Exception e) {
        ...
        private void doTest(IndexReader reader, TermDocs docs, String i,
