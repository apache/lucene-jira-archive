...
rowsTrunk = cPickle.load(open('/Users/jrutherg/dev/LUCENE-1539/contrib/benchmark/results.pk'))
d = {}
...
rowsPatch = cPickle.load(open('/Users/jrutherg/dev/LUCENE-1539/contrib/benchmark/results.pk'))
