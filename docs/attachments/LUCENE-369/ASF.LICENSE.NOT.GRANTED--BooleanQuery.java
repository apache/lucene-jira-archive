...
public class BooleanQuery extends Query {
   ...
   * to override. If a failure to get the system property occurs, perhaps because
   * Lucene is being used in an unsigned applet, use the default.
  ...
  public static int maxClauseCount;
	static {
		try {
			maxClauseCount = Integer.parseInt(System.getProperty("org.apache.lucene.maxClauseCount", "1024"));
		} catch ( Exception e ) {
			maxClauseCount = 1024;
		}
	}
