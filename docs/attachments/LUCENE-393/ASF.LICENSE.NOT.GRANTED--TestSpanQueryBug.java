 ...
 * TestSpanQueryBug
 *  
 * Original author: Reece Wilton
 */

package test.lucene.search.spans;
 ...
 * @author Reece Wilton
 */
public class TestSpanQueryBug extends TestCase {
     ...
     * @param expectedHits the number of hits that should be found
