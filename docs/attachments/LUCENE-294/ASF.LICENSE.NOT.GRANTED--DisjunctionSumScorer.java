...
import java.util.Collection;
 ...
 /** A DisjunctionScorer that adds all subscores.
 */
public class DisjunctionSumScorer extends DisjunctionScorer {
  public DisjunctionSumScorer( Collection subScorers, int minimumNrMatchers, Similarity similarity) {
    super(subScorers, minimumNrMatchers, similarity);
  }

  public DisjunctionSumScorer( Collection subScorers, Similarity similarity) {
