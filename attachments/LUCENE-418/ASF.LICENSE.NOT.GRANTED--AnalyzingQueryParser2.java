 ...
 * are also passed through the given analyzer, but that wildcards etc don't get removed from 
 * the terms.
 *
...
public class AnalyzingQueryParser extends org.apache.lucene.queryParser.QueryParser {
  ...
  public AnalyzingQueryParser(org.apache.lucene.queryParser.CharStream c) {
    super(c);
  }

  public AnalyzingQueryParser(org.apache.lucene.queryParser.QueryParserTokenManager t) {
    super(t);
  }
  ...
  protected Query getWildcardQuery(String field, String termStr) throws ParseException {
    ...
    if (tlist.size() == 0) {
      ...
      if (wlist != null && wlist.size() == 1) {
        ...
        throw new RuntimeException("getWildcardQuery called without wildcard");
      }
    } else {
