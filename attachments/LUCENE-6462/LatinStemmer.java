...
public class LatinStemmer {
	...
	public static void main(String [] args){
		LatinStemmer ls = new LatinStemmer();
		char[] s = new String("centurioni").toCharArray();
		System.out.println(ls.stemAsNoun(s, 10));
	}
	public LatinStemmer() {
	...
	public String stemAsNoun(char termBuffer[], int termLength) {
		...
		if ((noun.endsWith("ibus") || noun.endsWith("arum") || noun.endsWith("erum") || noun.endsWith("orum") || noun.endsWith("ebus")) && noun.length() >= 6) {
			...
			stemmed = String.valueOf(termBuffer, 0, termLength - 3);
				...
				|| noun.endsWith("ia") || noun.endsWith("is") || noun.endsWith("nt") || noun.endsWith("os")
	...
	/*	if (verb.endsWith("iuntur") || verb.endsWith("erunt") || verb.endsWith("untur") || verb.endsWith("iunt") || verb.endsWith("unt")) {
		...
		if ((verb.endsWith("issemus") || verb.endsWith("issetis") || verb.endsWith("assemus") || verb.endsWith("assetis")) && termLength >= 9) {
			// 'iuntur' 'erunt' 'untur' 'iunt' 'unt' -> 'i'
			stemmed = String.valueOf(termBuffer, 0, termLength - 7);
		} else if ((verb.endsWith("bantur") || verb.endsWith("eramus") || verb.endsWith("erimus") || verb.endsWith("eratis")  || verb.endsWith("eritis")  
				|| verb.endsWith("issent") || verb.endsWith("assent") ) && termLength >= 8) {
			// 'iuntur' 'erunt' 'untur' 'iunt' 'unt' -> 'i'
			stemmed  = String.valueOf(termBuffer, 0, termLength - 6);
		} else if((verb.endsWith("bamus") || verb.endsWith("batis") || verb.endsWith("bimus") || verb.endsWith("bitis") || verb.endsWith("batur") 
				|| verb.endsWith("baris")  || verb.endsWith("resum") || verb.endsWith("retis") || verb.endsWith("beris") ||  verb.endsWith("erunt") ||
				verb.endsWith("issem")  || verb.endsWith("isses") || verb.endsWith("isset") || verb.endsWith("assem")  || verb.endsWith("asses") || verb.endsWith("asset") ||  
				verb.endsWith("erint") || verb.endsWith("erant")) && termLength >= 7) { 
			// 'mini' 'ntur' 'stis' -> delete
			stemmed = String.valueOf(termBuffer, 0, termLength - 5);
		} else if ((verb.endsWith("mini") || verb.endsWith("ntur") || verb.endsWith("stis") || verb.endsWith("isti") ||
				verb.endsWith("bant") || verb.endsWith("bunt") || verb.endsWith("rent") || verb.endsWith("asse") ||
				verb.endsWith("eram") || verb.endsWith("eras") || verb.endsWith("erat") || verb.endsWith("isse") ||
				verb.endsWith("eris") || verb.endsWith("erim") || verb.endsWith("erit") || verb.endsWith("ibus")) && termLength >= 6) {
			// 'mini' 'ntur' 'stis' -> delete
			stemmed = String.valueOf(termBuffer, 0, termLength - 4);
		} else if ((verb.endsWith("mus") || verb.endsWith("mur") || verb.endsWith("ris") || verb.endsWith("sti") || verb.endsWith("tis")
				|| verb.endsWith("bam") || verb.endsWith("bas") || verb.endsWith("bat") || verb.endsWith("rem") || verb.endsWith("res")	
				|| verb.endsWith("ret") || verb.endsWith("bis") || verb.endsWith("bit") || verb.endsWith("tur")
				|| verb.endsWith("are") || verb.endsWith("ire") || verb.endsWith("ere") || verb.endsWith("ari")) && termLength >= 5) {
			// 'mus' 'ris' 'sti' 'tis' 'tur' -> delete
			stemmed = String.valueOf(termBuffer, 0, termLength - 3);
		} else if ((verb.endsWith("ns") || verb.endsWith("nt") || verb.endsWith("nt") || verb.endsWith("it") ||
				verb.endsWith("ae") || verb.endsWith("am") || verb.endsWith("as") || verb.endsWith("em") || verb.endsWith("es")
				|| verb.endsWith("eo") 	|| verb.endsWith("ia") || verb.endsWith("is") || verb.endsWith("nt") || verb.endsWith("os")
				|| verb.endsWith("um") || verb.endsWith("us") || verb.endsWith("ei") || verb.endsWith("ui") || verb.endsWith("im"))
						 && termLength >= 4) {
			// 'ns' 'nt' 'ri' -> delete
			stemmed =  String.valueOf(termBuffer, 0, termLength - 2);
		} else if ((verb.endsWith("m") || verb.endsWith("r") || verb.endsWith("s") || verb.endsWith("t") ||
				verb.endsWith("a") || verb.endsWith("e") || verb.endsWith("i") || verb.endsWith("o") || verb.endsWith("u")) && termLength >= 3) {
			// 'm' 'r' 's' 't' -> delete
			stemmed =  String.valueOf(termBuffer, 0, termLength - 1);
		}
		if(stemmed.endsWith("and") || stemmed.endsWith("ant")){
