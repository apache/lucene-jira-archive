...
/**
 * Test of the MaxDisjunctionQuery.
 *
 */
public class TestMaxDisjunctionQuery extends TestCase{
    ...
    public void testSimpleEqualScores1() throws Exception {
        ...
        MaxDisjunctionQuery q = new MaxDisjunctionQuery(0.0f);
        q.add(tq("hed","albino"));
    ...
    public void testSimpleTiebreaker() throws Exception {
        ...
        MaxDisjunctionQuery q = new MaxDisjunctionQuery(0.01f);
        q.add(tq("dek","albino"));
        q.add(tq("dek","elephant"));
    ...
    public void testBooleanRequiredEqualScores() throws Exception {
        ...
        {
            MaxDisjunctionQuery q1 = new MaxDisjunctionQuery(0.0f);
            q1.add(tq("hed","albino"));
            q1.add(tq("dek","albino"));
            q.add(q1,true,false);
        }
        {
            MaxDisjunctionQuery q2 = new MaxDisjunctionQuery(0.0f);
    ...
    public void testBooleanOptionalWithTiebreaker() throws Exception {
        ...
        BooleanQuery q = new BooleanQuery();
        {
            MaxDisjunctionQuery q1 = new MaxDisjunctionQuery(0.01f);
            q1.add(tq("hed","albino"));
            q1.add(tq("dek","albino"));
            q.add(q1,false,false);
        }
        {
            MaxDisjunctionQuery q2 = new MaxDisjunctionQuery(0.01f);
            q2.add(tq("hed","elephant"));
            q2.add(tq("dek","elephant"));
            q.add(q2,false,false);
        }
