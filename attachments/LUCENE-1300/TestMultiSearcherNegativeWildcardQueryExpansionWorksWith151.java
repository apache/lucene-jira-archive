 ...
 * 
 */
public class TestMultiSearcherNegativeWildcardQueryExpansionWorksWith151 extends
   TestCase {
  private MultiSearcher multiSearcher;

  private IndexSearcher indexSearcher1, indexSearcher2;

  public TestMultiSearcherNegativeWildcardQueryExpansionWorksWith151(String name) {
    super(name);
  }
  ...
  private static Document createSingleFieldDoc(String contents) {
    ...
    //Changed to work with lucene-1.5-rc1-dev.jar
//    document.add(new Field(defaultFieldName, contents, Field.Store.YES,
//            Field.Index.TOKENIZED));
    document.add(new Field(defaultFieldName, contents, true, true, true));
    return document;
  }
  ...
  public void testNegativeWildcardSearchOnMultiSearcher() throws Exception {
    ...
    assertTrue(
        ...
        hits.length() +
        " results, when it should be 1 like it was on " +
