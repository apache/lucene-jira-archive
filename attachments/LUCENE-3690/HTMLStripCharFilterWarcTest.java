...
public class HTMLStripCharFilterWarcTest {
	...
	if (args.length != 1) {
	    System.err.println("Usage: HTMLStripCharFilterWarcTest <warc-gz-file>");
	    System.exit(1);
	}
	...
	while (null != (warcRecord = WarcRecord.readNextWarcRecord(inStream))) {
		...
		Reader charFilterReader = new HTMLStripCharFilter(CharReader.get(inReader));
